"""
LaTeX Generator for Daily Office Prayer

This module converts API responses from the Daily Office 2019 API
into well-formatted LaTeX documents and PDFs.
"""
...
class LatexGenerator:
    """
    Generates formatted LaTeX documents from Daily Office API responses.

    This class handles the conversion of liturgical content including headings,
    prayers, psalms, Scripture readings, and rubrics into LaTeX format for
    ...
    def generate_latex(self, api_response: Dict[str, Any], title: str = "Daily Office", page_size: str = "letter", label: Optional[str] = None) -> str:
        ...
        if label:
            sections.append(r'\phantomsection\label{' + label + r'}')
    ...
    def generate_morning_prayer(self, api_response: Dict[str, Any], page_size: str = "letter", label: Optional[str] = None) -> str:
        """
    ...
    def generate_evening_prayer(self, api_response: Dict[str, Any], page_size: str = "letter", label: Optional[str] = None) -> str:
        """
    ...
    def generate_midday_prayer(self, api_response: Dict[str, Any], page_size: str = "letter", label: Optional[str] = None) -> str:
        """
    ...
    def generate_compline(self, api_response: Dict[str, Any], page_size: str = "letter", label: Optional[str] = None) -> str:
        """
